...
const ALL_CARDS: CardDef[] = [
  ...
  { id: "bottle-inventory", href: "/admin/inventory", title: "Bottle Inventory", description: "Track raw bottle stock by cutting/polishing stage for Home Goods", icon: Boxes, iconBg: "bg-lime-100", iconColor: "text-lime-600", defaultSize: "large" },
...
export type LayoutData = { large: string[]; small: string[] };
